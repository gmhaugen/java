...
/*
 * @Author: 140464
 * @Description: Class for deciphering a ciphered text using the Vigenère cipher.
...
public class VigenereDecoder {
	...
	public void decode(String cipherText, String key) {
		...
		for (int i = 0; i < cipherTextNumbers.size(); i++) {
			...
			// Subtracting value from the ciphertext with the value from the key
			decodedValue = cipherTextNumbers.get(i) - keyNumbers.get(keyCounter);
